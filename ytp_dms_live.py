...
#-------google sheet-------
gc = pygsheets.authorize(service_file='./norse-decoder-292505-51c31aab7824.json')
sht = gc.open_by_url(
'https://docs.google.com/spreadsheets/d/1wPLYr7-HZzRW8szBAtkZhqAXJpNLcU7CxRnJ0BAIQiQ/edit#gid=0/'
)
...
def upload_status():
    ...
    if upload_counter%100==0:
        ...
        datetime_str = loc_dt.strftime("%Y/%m/%d %H:%M:%S")

        values = [[str(datetime_str), dms_status4,dms_status1,dms_status2,dms_status3]]

...
def headpose(img,face_points):
    ...
    if max_index==0 :
        ...
        cv2.putText(img, "Look       ", (0, 80), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    if max_index2==0 :
        ...
        cv2.putText(img, "Look       ", (0, 120), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 0), 2)
    ...
    if label:
        ...
        if "face" in label:
            ...
            if right_eye_down[0][1]-right_eye_up[0][1]<=5 :
                cv2.putText(img, "Close eyes", (0, 160), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            elif left_eye_down[0][1]-left_eye_up[0][1] <=5 :
                cv2.putText(img, "Close eyes", (0, 160), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            elif mouth_down[0][1]-mouth_up[0][1]>=30:
                cv2.putText(img, "Open mouth", (0, 160), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            else:
                cv2.putText(img, "Normal     ", (0, 160), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)

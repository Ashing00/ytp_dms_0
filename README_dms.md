...
python train.py --workers 8 --device 0 --batch-size 8 --data data/dms.yaml --img 640 640 --cfg cfg/training/yolov7_dms.yaml --weights '' --name yolov7_dms --hyp data/hyp.scratch.p5.yaml

python train.py --workers 8 --device 0 --batch-size 8 --data data/dms_face.yaml --img 640 640 --cfg cfg/training/yolov7_dms_face.yaml --weights '' --name yolov7_dms_face --hyp data/hyp.scratch.p5.yaml

python train.py --workers 8 --device 0 --batch-size 8 --data data/gastroscopy.yaml --img 640 640 --cfg cfg/training/yolov7_gastroscopy.yaml --weights '' --name yolov7_gastroscopy --hyp data/hyp.scratch.p5.yaml


python train.py --workers 8 --device 0 --batch-size 4 --data data/gastroscopy.yaml --img 1280 1280 --cfg cfg/training/yolov7_gastroscopy.yaml --weights '' --name yolov7_gastroscopy --hyp data/hyp.scratch.p5.yaml
...
python detect.py --weights ./runs/train/yolov7_dms/weights/best.pt --conf 0.65 --img-size 640 --source 0
python detect.py --weights ./runs/train/yolov7_dms_face/weights/best.pt --conf 0.65 --img-size 640 --source 0

python detect.py --weights ./runs/train/yolov7_gastroscopy/weights/best.pt --conf 0.65 --img-size 640 --source ./data/gastroscopy/video/1f7e03fd-06da-4823-94a6-11293897f545.avi 
python detect.py --weights ./runs/train/yolov7_gastroscopy/weights/best.pt --conf 0.65 --img-size 640 --source ./data/gastroscopy/video/89a4fc64-d698-4c09-ad17-f89257182cc2.avi 
